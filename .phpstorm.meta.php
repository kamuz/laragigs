...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Server\home\laragigs.loc\public\storage' => 'string',
...
'cache.prefix','clockwork.enable','clockwork.features.cache.enabled','clockwork.features.cache.collect_queries','clockwork.features.cache.collect_values',
'clockwork.features.database.enabled','clockwork.features.database.collect_queries','clockwork.features.database.collect_models_actions','clockwork.features.database.collect_models_retrieved','clockwork.features.database.slow_threshold',
'clockwork.features.database.slow_only','clockwork.features.database.detect_duplicate_queries','clockwork.features.events.enabled','clockwork.features.events.ignored_events','clockwork.features.log.enabled',
'clockwork.features.notifications.enabled','clockwork.features.performance.client_metrics','clockwork.features.queue.enabled','clockwork.features.redis.enabled','clockwork.features.routes.enabled',
'clockwork.features.routes.only_namespaces','clockwork.features.views.enabled','clockwork.features.views.collect_data','clockwork.features.views.use_twig_profiler','clockwork.web',
'clockwork.toolbar','clockwork.requests.on_demand','clockwork.requests.errors_only','clockwork.requests.slow_threshold','clockwork.requests.slow_only',
'clockwork.requests.sample','clockwork.requests.except','clockwork.requests.only','clockwork.requests.except_preflight','clockwork.artisan.collect',
'clockwork.artisan.except','clockwork.artisan.only','clockwork.artisan.collect_output','clockwork.artisan.except_laravel_commands','clockwork.queue.collect',
'clockwork.queue.except','clockwork.queue.only','clockwork.tests.collect','clockwork.tests.except','clockwork.collect_data_always',
'clockwork.storage','clockwork.storage_files_path','clockwork.storage_files_compress','clockwork.storage_sql_database','clockwork.storage_sql_table',
'clockwork.storage_redis','clockwork.storage_redis_prefix','clockwork.storage_expiration','clockwork.authentication','clockwork.authentication_password',
'clockwork.stack_traces.enabled','clockwork.stack_traces.limit','clockwork.stack_traces.skip_vendors','clockwork.stack_traces.skip_namespaces','clockwork.stack_traces.skip_classes',
'clockwork.serialization_depth','clockwork.serialization_blackbox','clockwork.register_helpers','clockwork.headers','clockwork.server_timing',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.C:\\Server\\home\\laragigs.loc\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'login','storage.local',);
        registerArgumentsSet('views', 
'components.flash-message','components.listing-tags','layout','listings.create','listings.edit',
'listings.index','listings.manage','listings.show','pagination::bootstrap-4','pagination::bootstrap-5',
...
'pagination::simple-tailwind','pagination::tailwind','partials.hero','partials.search','users.login',
'users.register','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.default','vendor.pagination.semantic-ui',
...
'DB_USERNAME','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH',
